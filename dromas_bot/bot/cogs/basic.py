...
class BasicCog(commands.Cog):
    ...
    async def ping(self, interaction: discord.Interaction) -> None:
        await interaction.response.send_message("삐빅. 드로마스는 깨어 있어.\n우웅... 기록 장치도 정상 작동 중이야.")
    ...
    async def help(self, interaction: discord.Interaction) -> None:
        ...
        embed.add_field(name="/드로마스먹이주기", value="포만감과 기분을 올립니다. 하루 5회, 쿨타임 1분.", inline=False)
        embed.add_field(name="/드로마스놀아주기", value="기분과 친밀도를 올립니다. 하루 10회, 쿨타임 1분.", inline=False)
        embed.add_field(name="/드로마스탐사", value="경험치를 얻습니다. 하루 3회, 쿨타임 2분.", inline=False)
